  ...
  return (
    <div className="mt-2 p-2">
      ...
      <div className="p-2 mt-3">
        ...
        <div className="p-4 border border-white-100/10 rounded-md flex items-center justify-around gap-1">
        ...
        <ul className="flex flex-col gap-4 p-4 border border-white-100/10 rounded-md">
          {
                ...
                .map(([key, value]) => (
                  <li className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div style={{ width: `calc(${value.under}% - 40px)` }} className="w-full min-w-[60px]  h-[25px] flex items-center justify-end border border-highlight-600 bg-highlight-600/10 px-2">

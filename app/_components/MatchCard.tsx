...
function MatchCard ({ _id, status, minute, utcDate, homeTeam, awayTeam, score }: Match) {
    ...
    return (
        <Link href={`/match/${_id}`} className={`flex items-center border-b border-secondary-900/10 last:border-transparent justify-between ${cardBackground} hover:border-transparent hover:bg-secondary-900/5 p-2`}>

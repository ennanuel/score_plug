        ...
        status === 'TIMED' ? 
          ...
          <div className="col-span-3">
            <div className="relative mt-1 mb-2 h-2 rounded-lg bg-secondary-900 overflow-clip">
              ...
              <div style={{ width: `${predictions.fullTime.outcome.draw + predictions.fullTime.outcome.homeWin}%`}} className="absolute top-0 left-0 h-full rounded-r-lg bg-highlight-500 shadow-lg" />
              <div style={{ width: `${predictions.fullTime.outcome.homeWin}%`}} className="absolute top-0 left-0 h-full rounded-r-lg bg-highlight-300" />
            </div>

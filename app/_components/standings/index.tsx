        ...
        <div className="flex flex-col gap-4">
            {
                competition.standings.map((standing) => (
                    <div>
                        {competition.type === 'CUP' && <h3 className="mt-4 p-2 px-4 border-t border-white-100/5 bg-white-100/5 font-semibold text-sm">{standing.group}</h3>}
                    <table className="w-full border-b border-secondary-900/50">

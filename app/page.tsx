    ...
    <main className="py-4 bg-primary-600">
      <div className="flex items-center justify-between">
        ...
        <div className="h-[50px] flex items-stretch justify-stretch text-sm">
          ...
          <button onClick={showLiveMatches} className={`flex justify-center items-center gap-2 px-4 min-w-[120px] font-semibold ${status === "IN_PLAY" ? 'border-l border-secondary-900/50 text-green-300 bg-green-400/20' : 'border-r border-secondary-900/50 text-green-700'}`}>

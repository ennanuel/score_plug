...
const TeamMatches = () => {
    ...
    if(loading) return (
        <div className="grid grid-cols-[1fr,_360px] gap-4">
            <DetailsLoading key="component_1" />
                        ...
                        <div className="rounded-xl border border-transparent bg-[#191919]">
                            ...
                            <ul className="flex flex-col p-4 gap-4">
                                <li className="grid grid-cols-[1fr,_auto,_1fr] items-center gap-3 h-5">
                                    ...
                                    <span className="text-2xs text-white-700 text-center">Table Position</span>
                                ...
                                <li className="grid grid-cols-[1fr,_auto,_1fr] items-center gap-3 h-5">
                                    ...
                                    <span className="text-2xs text-white-700 text-center">Goals per match</span>
                                    <div className="flex justify-end h-full">
                                        <span className="relative flex items-center justify-center px-1 min-w-5 text-3xs font-semibold text-white-100">
                                ...
                                <li className="grid grid-cols-[1fr,_auto,_1fr] items-center gap-3 h-5">
                                    <div className="flex justify-start h-full">
                                        <span className="relative flex items-center justify-center px-1 min-w-5 max-h-5 text-3xs font-semibold text-white-100">
                                    ...
                                    <span className="text-2xs text-white-700 text-center">Goals conceded per match</span>
                                    <div className="flex justify-end h-full">
                                        <span className="relative flex items-center justify-center px-1 min-w-5 max-h-5 text-3xs font-semibold text-white-100">
